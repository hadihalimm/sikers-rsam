...
const IndikatorSasaranTable = ({
  ...
  if (sasaranId === 0) {
    return (
      <div className="w-1/3 border-l border-t border-b rounded-lg p-2 self-start">
  ...
  return (
    <div className="w-1/3 flex flex-col gap-y-3 border-l border-t border-b rounded-lg p-2 self-start">
      <div>
        <h1 className="font-semibold text-lg">Daftar Indikator Sasaran</h1>
        <p>{sasaran?.judul}</p>
      </div>
