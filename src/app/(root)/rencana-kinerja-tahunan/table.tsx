...
import {
  useDeleteRencanaKinerjaTahunan,
  useGetAllRencanaKinerjaTahunan,
...
const RencanaKinerjaTahunanTable = () => {
  ...
  const [editingItem, setEditingItem] = useState<RencanaKinerjaTahunan>();

  const columnHelper = createColumnHelper<RencanaKinerjaTahunan>();
  const columns = [
  ...
  const { data = [] } = useGetAllRencanaKinerjaTahunan();
  const { data: cascadingList = [] } = useGetAllCascading();
  const deleteRencanaKinerjaTahunan = useDeleteRencanaKinerjaTahunan();
  ...
  return (
    <div className="flex flex-col gap-y-4">
      ...
      <DeleteAlertDialog
        ...
        onSuccess={() => {
          deleteRencanaKinerjaTahunan.mutate(editingItem!.id);
          setEditingItem(undefined);
          setDeleteDialogOpen(false);
          toast.info('Rencana Kinerja Tahunan berhasil dihapus');
        }}
      />
    </div>
  );
...
export default RencanaKinerjaTahunanTable;
